...
export const SettingsSchema = z.object({
    ...
    voiceEngine: z.enum(['elevenlabs', 'gemini']).describe('Voice engine to use for voice assistant'),
    geminiApiKey: z.string().nullable().describe('Gemini API key for voice assistant'),
    geminiBaseUrl: z.string().nullable().describe('Gemini API base URL (optional, for proxy)'),
