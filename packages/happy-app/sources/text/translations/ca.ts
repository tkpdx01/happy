...
export const ca: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        voiceEngine: 'Motor de veu',
        voiceEngineDescription: 'Tria quin motor de veu utilitzar per a l\'assistent de veu.',
        engineElevenLabs: 'ElevenLabs',
        engineGemini: 'Gemini',
        geminiApiKey: 'Clau API de Gemini',
        geminiApiKeyPlaceholder: 'Introdueix la teva clau API de Gemini',
        geminiApiKeyRequired: 'Introdueix una clau API de Gemini a Configuració > Veu per utilitzar la veu de Gemini.',
        geminiBaseUrl: 'URL base de l\'API',
        geminiBaseUrlPlaceholder: 'URL base personalitzada de l\'API (opcional)',
        geminiBaseUrlHint: 'Deixa buit per utilitzar el punt d\'accés predeterminat de Google API. Estableix una URL personalitzada si fas servir un proxy.',
        geminiGetApiKey: 'Obtén una clau API gratuïta a Google AI Studio',
        geminiTestConnection: 'Provar connexió',
        geminiTestSuccess: 'Connexió correcta',
        geminiTestFailed: 'Error de connexió',
        geminiTestInvalidKey: 'Clau API no vàlida',
        geminiTestTimeout: 'Temps de connexió esgotat. Potser necessites un proxy.',
        geminiTestNetworkError: 'Error de xarxa. Potser necessites un proxy.',
    },
