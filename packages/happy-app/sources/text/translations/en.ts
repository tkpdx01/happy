...
export const en: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        voiceEngineDescription: 'Choose which voice engine to use for voice assistant.',
        engineElevenLabs: 'ElevenLabs',
        engineGemini: 'Gemini',
        geminiApiKey: 'Gemini API Key',
        geminiApiKeyPlaceholder: 'Enter your Gemini API key',
        geminiApiKeyRequired: 'Please enter a Gemini API key in Settings > Voice to use Gemini voice.',
        geminiBaseUrl: 'API Base URL',
        geminiBaseUrlPlaceholder: 'Custom API base URL (optional)',
        geminiBaseUrlHint: 'Leave empty to use the default Google API endpoint. Set a custom URL if using a proxy.',
        geminiGetApiKey: 'Get a free API key from Google AI Studio',
        geminiTestConnection: 'Test Connection',
        geminiTestSuccess: 'Connected successfully',
        geminiTestFailed: 'Connection failed',
        geminiTestInvalidKey: 'Invalid API key',
        geminiTestTimeout: 'Connection timed out. You may need a proxy.',
        geminiTestNetworkError: 'Network error. You may need a proxy.',
    },
