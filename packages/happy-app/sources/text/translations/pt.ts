...
export const pt: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        voiceEngineDescription: 'Escolha qual motor de voz usar para o assistente de voz.',
        engineElevenLabs: 'ElevenLabs',
        engineGemini: 'Gemini',
        geminiApiKey: 'Chave API do Gemini',
        geminiApiKeyPlaceholder: 'Insira sua chave API do Gemini',
        geminiApiKeyRequired: 'Insira uma chave API do Gemini em Configurações > Voz para usar a voz do Gemini.',
        geminiBaseUrl: 'URL base da API',
        geminiBaseUrlPlaceholder: 'URL base personalizada da API (opcional)',
        geminiBaseUrlHint: 'Deixe vazio para usar o endpoint padrão da Google API. Defina uma URL personalizada se estiver usando um proxy.',
        geminiGetApiKey: 'Obtenha uma chave API gratuita no Google AI Studio',
        geminiTestConnection: 'Testar conexão',
        geminiTestSuccess: 'Conexão bem-sucedida',
        geminiTestFailed: 'Falha na conexão',
        geminiTestInvalidKey: 'Chave API inválida',
        geminiTestTimeout: 'Tempo de conexão esgotado. Pode ser necessário um proxy.',
        geminiTestNetworkError: 'Erro de rede. Pode ser necessário um proxy.',
    },
