...
export const it: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        voiceEngineDescription: 'Scegli quale motore vocale utilizzare per l\'assistente vocale.',
        engineElevenLabs: 'ElevenLabs',
        engineGemini: 'Gemini',
        geminiApiKey: 'Chiave API Gemini',
        geminiApiKeyPlaceholder: 'Inserisci la tua chiave API Gemini',
        geminiApiKeyRequired: 'Inserisci una chiave API Gemini in Impostazioni > Voce per usare la voce Gemini.',
        geminiBaseUrl: 'URL base API',
        geminiBaseUrlPlaceholder: 'URL base API personalizzato (opzionale)',
        geminiBaseUrlHint: 'Lascia vuoto per usare l\'endpoint predefinito di Google API. Imposta un URL personalizzato se usi un proxy.',
        geminiGetApiKey: 'Ottieni una chiave API gratuita da Google AI Studio',
        geminiTestConnection: 'Testa connessione',
        geminiTestSuccess: 'Connessione riuscita',
        geminiTestFailed: 'Connessione fallita',
        geminiTestInvalidKey: 'Chiave API non valida',
        geminiTestTimeout: 'Connessione scaduta. Potrebbe essere necessario un proxy.',
        geminiTestNetworkError: 'Errore di rete. Potrebbe essere necessario un proxy.',
    },
