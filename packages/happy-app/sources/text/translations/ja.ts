...
export const ja: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        voiceEngine: '音声エンジン',
        voiceEngineDescription: '音声アシスタントに使用する音声エンジンを選択してください。',
        engineElevenLabs: 'ElevenLabs',
        engineGemini: 'Gemini',
        geminiApiKey: 'Gemini APIキー',
        geminiApiKeyPlaceholder: 'Gemini APIキーを入力',
        geminiApiKeyRequired: 'Gemini音声を使用するには、設定 > 音声でGemini APIキーを入力してください。',
        geminiBaseUrl: 'APIベースURL',
        geminiBaseUrlPlaceholder: 'カスタムAPIベースURL（任意）',
        geminiBaseUrlHint: 'デフォルトのGoogle APIエンドポイントを使用する場合は空のままにしてください。プロキシを使用する場合はカスタムURLを設定してください。',
        geminiGetApiKey: 'Google AI Studioで無料のAPIキーを取得',
        geminiTestConnection: '接続テスト',
        geminiTestSuccess: '接続成功',
        geminiTestFailed: '接続失敗',
        geminiTestInvalidKey: '無効なAPIキー',
        geminiTestTimeout: '接続がタイムアウトしました。プロキシが必要かもしれません。',
        geminiTestNetworkError: 'ネットワークエラー。プロキシが必要かもしれません。',
    },
