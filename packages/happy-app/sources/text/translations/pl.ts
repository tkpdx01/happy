...
export const pl: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        voiceEngine: 'Silnik głosowy',
        voiceEngineDescription: 'Wybierz silnik głosowy dla asystenta głosowego.',
        engineElevenLabs: 'ElevenLabs',
        engineGemini: 'Gemini',
        geminiApiKey: 'Klucz API Gemini',
        geminiApiKeyPlaceholder: 'Wprowadź klucz API Gemini',
        geminiApiKeyRequired: 'Wprowadź klucz API Gemini w Ustawienia > Głos, aby używać głosu Gemini.',
        geminiBaseUrl: 'Bazowy URL API',
        geminiBaseUrlPlaceholder: 'Niestandardowy bazowy URL API (opcjonalnie)',
        geminiBaseUrlHint: 'Pozostaw puste, aby użyć domyślnego punktu końcowego Google API. Ustaw niestandardowy URL, jeśli używasz proxy.',
        geminiGetApiKey: 'Uzyskaj darmowy klucz API z Google AI Studio',
        geminiTestConnection: 'Testuj połączenie',
        geminiTestSuccess: 'Połączono pomyślnie',
        geminiTestFailed: 'Połączenie nie powiodło się',
        geminiTestInvalidKey: 'Nieprawidłowy klucz API',
        geminiTestTimeout: 'Przekroczono limit czasu połączenia. Może być potrzebny proxy.',
        geminiTestNetworkError: 'Błąd sieci. Może być potrzebny proxy.',
    },
