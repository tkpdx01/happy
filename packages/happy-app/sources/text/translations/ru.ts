...
export const ru: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        voiceEngineDescription: 'Выберите голосовой движок для голосового ассистента.',
        engineElevenLabs: 'ElevenLabs',
        engineGemini: 'Gemini',
        geminiApiKey: 'API-ключ Gemini',
        geminiApiKeyPlaceholder: 'Введите ваш API-ключ Gemini',
        geminiApiKeyRequired: 'Введите API-ключ Gemini в Настройки > Голос для использования голоса Gemini.',
        geminiBaseUrl: 'Базовый URL API',
        geminiBaseUrlPlaceholder: 'Пользовательский базовый URL API (необязательно)',
        geminiBaseUrlHint: 'Оставьте пустым для использования стандартной точки доступа Google API. Укажите URL при использовании прокси.',
        geminiGetApiKey: 'Получить бесплатный API-ключ в Google AI Studio',
        geminiTestConnection: 'Проверить подключение',
        geminiTestSuccess: 'Подключение успешно',
        geminiTestFailed: 'Ошибка подключения',
        geminiTestInvalidKey: 'Недействительный API-ключ',
        geminiTestTimeout: 'Время подключения истекло. Возможно, нужен прокси.',
        geminiTestNetworkError: 'Ошибка сети. Возможно, нужен прокси.',
    },
