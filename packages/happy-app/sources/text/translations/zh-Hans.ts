...
export const zhHans: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        voiceEngine: '语音引擎',
        voiceEngineDescription: '选择语音助手使用的语音引擎。',
        engineElevenLabs: 'ElevenLabs',
        engineGemini: 'Gemini',
        geminiApiKey: 'Gemini API 密钥',
        geminiApiKeyPlaceholder: '输入你的 Gemini API 密钥',
        geminiApiKeyRequired: '请在设置 > 语音中输入 Gemini API 密钥以使用 Gemini 语音。',
        geminiBaseUrl: 'API 基础 URL',
        geminiBaseUrlPlaceholder: '自定义 API 基础 URL（可选）',
        geminiBaseUrlHint: '留空以使用默认的 Google API 端点。如果使用代理，请设置自定义 URL。',
        geminiGetApiKey: '从 Google AI Studio 获取免费 API 密钥',
        geminiTestConnection: '测试连接',
        geminiTestSuccess: '连接成功',
        geminiTestFailed: '连接失败',
        geminiTestInvalidKey: '无效的 API 密钥',
        geminiTestTimeout: '连接超时，可能需要使用代理。',
        geminiTestNetworkError: '网络错误，可能需要使用代理。',
    },
