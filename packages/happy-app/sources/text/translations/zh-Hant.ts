...
export const zhHant: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        voiceEngine: '語音引擎',
        voiceEngineDescription: '選擇語音助手使用的語音引擎。',
        engineElevenLabs: 'ElevenLabs',
        engineGemini: 'Gemini',
        geminiApiKey: 'Gemini API 金鑰',
        geminiApiKeyPlaceholder: '輸入你的 Gemini API 金鑰',
        geminiApiKeyRequired: '請在設定 > 語音中輸入 Gemini API 金鑰以使用 Gemini 語音。',
        geminiBaseUrl: 'API 基礎 URL',
        geminiBaseUrlPlaceholder: '自訂 API 基礎 URL（選填）',
        geminiBaseUrlHint: '留空以使用預設的 Google API 端點。如果使用代理，請設定自訂 URL。',
        geminiGetApiKey: '從 Google AI Studio 取得免費 API 金鑰',
        geminiTestConnection: '測試連線',
        geminiTestSuccess: '連線成功',
        geminiTestFailed: '連線失敗',
        geminiTestInvalidKey: '無效的 API 金鑰',
        geminiTestTimeout: '連線逾時，可能需要使用代理。',
        geminiTestNetworkError: '網路錯誤，可能需要使用代理。',
    },
