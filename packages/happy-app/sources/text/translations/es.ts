...
export const es: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        voiceEngineDescription: 'Elige qué motor de voz usar para el asistente de voz.',
        engineElevenLabs: 'ElevenLabs',
        engineGemini: 'Gemini',
        geminiApiKey: 'Clave API de Gemini',
        geminiApiKeyPlaceholder: 'Introduce tu clave API de Gemini',
        geminiApiKeyRequired: 'Introduce una clave API de Gemini en Ajustes > Voz para usar la voz de Gemini.',
        geminiBaseUrl: 'URL base de la API',
        geminiBaseUrlPlaceholder: 'URL base personalizada de la API (opcional)',
        geminiBaseUrlHint: 'Deja vacío para usar el punto de acceso predeterminado de Google API. Establece una URL personalizada si usas un proxy.',
        geminiGetApiKey: 'Obtén una clave API gratuita en Google AI Studio',
        geminiTestConnection: 'Probar conexión',
        geminiTestSuccess: 'Conexión exitosa',
        geminiTestFailed: 'Error de conexión',
        geminiTestInvalidKey: 'Clave API no válida',
        geminiTestTimeout: 'Tiempo de conexión agotado. Es posible que necesites un proxy.',
        geminiTestNetworkError: 'Error de red. Es posible que necesites un proxy.',
    },
